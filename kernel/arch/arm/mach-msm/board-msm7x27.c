...
#ifdef CONFIG_ARCH_MSM7X27
/* FIH, WeiChihChen, 2010/03/31{ */
#ifdef CONFIG_FIH_FXX
    #if 0 //gain 19.8 for AP, gain 35.8 MB for AP if enable CONFIG_MSM_KGSL_MMU
    //For HVGA surface flinger gralloc, from 23 (20 + 3) MB -> (8MB + 1200KB)
    #define MSM_PMEM_MDP_SIZE	0xEBD000 // 0x92C000 + 0x591000
    ...
    #if 0 //gain 23.8 MB for AP, gain 39.8 MB for AP if enable CONFIG_MSM_KGSL_MMU
    //For HVGA surface flinger gralloc, from 23 (20 + 3) MB -> (8MB + 1200KB)
...
/* FIH, WeiChihChen, 2010/04/28{ */
    #if 1 //gain 27.4 MB for AP, gain 43.4 MB for AP if enable CONFIG_MSM_KGSL_MMU
    //For HVGA surface flinger gralloc, from 23 (20 + 3) MB -> (8MB + 1200KB)
